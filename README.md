...
本分支（`pmw3610-third-party`）使用 **`zmk-pmw3610-driver` 第三方驱动**。另见 `main` 分支，该分支已迁移至 Zephyr 内置驱动 + ZMK input-processors。

This branch (`pmw3610-third-party`) uses the **third-party `zmk-pmw3610-driver`**. See the `main` branch for the version using Zephyr built-in driver + ZMK input-processors.
