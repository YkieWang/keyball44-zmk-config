...
本分支（`main`）使用 **Zephyr 内置 PMW3610 驱动 + ZMK input-processors**。另见 `pmw3610-third-party` 分支，该分支使用 ykiewang fork + zmk-pmw3610-driver 第三方驱动。

This branch (`main`) uses the **Zephyr built-in PMW3610 driver + ZMK input-processors**. See the `pmw3610-third-party` branch for the version using ykiewang fork + third-party zmk-pmw3610-driver.
